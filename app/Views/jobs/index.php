    ...
    <div class="row g-0">
      ...
      <div class="col-md-3">
        <?php foreach ($jobs as $job): ?>
          <div class="card mb-3 job-card" data-job-id="<?php echo $job['jobs_id']; ?>">
            <div class="card-body">
      ...
      <div class="col-md-2">
        <div class="card">
          <img src="<?php echo base_url(); ?>public/assets/img/instagram/insta-1.jpg" class="card-img-top" alt="Advertisement">
          <div class="card-body">
